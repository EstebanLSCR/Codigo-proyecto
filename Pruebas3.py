...
f = Fitter(logeados, 
            distributions=['mielke','genlogistic'])
...
plt.xlabel('Reclamos transformación logarítmica')
plt.ylabel('Densidad') 
plt.savefig('P3.DenRec.jpeg', format='jpeg', dpi=1300)
...
rango_fechas = pd.date_range(datos['FechaRegistro'][19] - timedelta(days = 1), 
...
plt.savefig('P3.AjusBN.jpeg', format='jpeg', dpi=1300)
